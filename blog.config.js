...
const BLOG = {
  // Important page_id！！！Duplicate Template from  https://abaft-ship-270.notion.site/Hello-914943db20884088b7c38be7e9946c74?pvs=4
  NOTION_PAGE_ID:
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Allen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '0', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'yezihao0831@163.com', // 网站地址
